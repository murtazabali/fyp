...
function loadDiffSample() {
    ...
    var onError = function() {
        ...
        $('#editor').append('<p class="alert alert-error">Failed to load diff editor sample</p>');
    };
    ...
    function onProgress() {
        if (lhsData && rhsData) {
            diffEditor = monaco.editor.createDiffEditor(document.getElementById('editor-frame'), {
